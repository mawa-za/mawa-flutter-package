...
class TransactionNotes {
  ...
  static createComment(
    ...
    dynamic note =
        await createNote(value: comment, type: type, transaction: transaction);
    if (note.statusCode == 200 || note.statusCode == 201) {
      dynamic noteId = await NetworkRequests.decodeJson(note);
      dynamic notify = await Notification(id: noteId)
          .sendCommentNotification(receiver, email: email, sms: sms);
