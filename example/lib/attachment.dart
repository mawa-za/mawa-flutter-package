...
class LeaveAttachment extends StatefulWidget {

  static const String id = 'Leave Attachment';
  LeaveAttachment({Key? key,
  ...
  @override
  _LeaveAttachmentState createState() => _LeaveAttachmentState();
}

class _LeaveAttachmentState extends State<LeaveAttachment> {
                      ...
                      children: [
                        ...
                        if (file != null)//view button will only appear if file has value
                          ElevatedButton.icon(
                            style: ElevatedButton.styleFrom(primary: Colors.blue),
                            onPressed: () async {
                              File f = File(file!.bytes!.toList(), file!.name);
                              dynamic resp = await mawa.Attachments().uploadAttachment(file,
                                  documentType: LeaveAttachment.document,
                                  parentType: LeaveAttachment.parent,
                                  parentReference: LeaveAttachment.reference);
